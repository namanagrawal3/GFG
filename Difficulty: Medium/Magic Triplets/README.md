<h2><a href="https://www.geeksforgeeks.org/problems/magic-triplets4003/1?page=2&category=two-pointer-algorithm&sortBy=submissions">Magic Triplets</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array of size n, a triplet (a[i], a[j], a[k]) is called a Magic Triplet if a[i] &lt; a[j] &lt; a[k] and i &lt; j &lt; k. &nbsp;Count the number of magic triplets in a given array.</span><br>&nbsp;</p>
