<h2><a href="https://www.geeksforgeeks.org/problems/triplets-with-sum-with-given-range/1?page=2&category=two-pointer-algorithm&sortBy=submissions">Triplets with sum with given range</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>Arr[]&nbsp;</strong>of <strong>N</strong> distinct integers and a range from <strong>L</strong>&nbsp;to <strong>R</strong>, the task is to count the number of triplets having a sum in the range [L, R].</span></p>
